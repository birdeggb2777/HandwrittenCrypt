    ...
    public partial class Form3 : Form
    {
        ...
        private void Form3_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                for (int i = 0; i <= 255; i++)
                {
                    b0[i] = Convert.ToByte(str2.Substring(rgbnumber, 3));
                    rgbnumber += 3;
                ...
                for (int i = 0; i <= 255; i++)
                {
                    g0[i] = Convert.ToByte(str2.Substring(rgbnumber, 3));
                    rgbnumber += 3;
                }
                for (int i = 0; i <= 255; i++)
                {
                    r0[i] = Convert.ToByte(str2.Substring(rgbnumber, 3));
                    rgbnumber += 3;
                }
            }
            catch
        ...
        private void 輸出圖片ToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            Image c = default(Image);
            c = pictureBox1.Image;
            SaveFileDialog saveFileDialog = new SaveFileDialog();
